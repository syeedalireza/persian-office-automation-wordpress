        ...
        <div style="padding: 0;">
            <?php if (empty($items)): ?>
                <div style="text-align: center; padding: 80px 20px;">
                    ...
                    <h3 style="margin: 0 0 10px 0; color: var(--oa-gray-700);">هیچ نامه‌ای ارسال نشده</h3>
                </div>
            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ( $item->read_count > 0 ) : ?>
                                            <span style="color: var(--oa-success);">✅ <?php echo esc_html( (string) $item->read_count ); ?> نفر</span>
                                        <?php else : ?>
                                            <span style="color: var(--oa-gray-400);">❌ خوانده نشده</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php
